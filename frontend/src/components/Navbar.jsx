        ...
        <nav className={`fixed top-0 left-0 w-full flex items-center justify-between px-6 md:px-12 lg:px-20 xl:px-28 transition-all duration-300 z-50 ${isScrolled ? "bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 shadow-2xl py-3 md:py-3.5" : "bg-black/20 backdrop-blur-md py-4 md:py-5"}`}>
            ...
            <Link to='/' className="group">
                <div className="flex items-center gap-2">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-teal-900 via-teal-800 to-teal-700 flex items-center justify-center transform group-hover:scale-105 transition-transform duration-300 shadow-lg">
            ...
            <div className="hidden md:flex items-center gap-1 lg:gap-2 bg-white/10 backdrop-blur-sm rounded-full px-2 py-2">
                ...
                {user && (
                    <button onClick={() => isOwner ? navigate('/owner') : setShowHotelReg(true)} className="ml-2 px-5 py-2 text-sm font-medium rounded-full bg-gradient-to-br from-teal-700 via-teal-600 to-teal-700 text-white hover:from-teal-600 hover:to-teal-700 transform hover:scale-105 transition-all duration-300 shadow-lg">
